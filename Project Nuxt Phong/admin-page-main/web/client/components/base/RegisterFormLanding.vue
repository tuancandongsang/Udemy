<template>
  <v-card
    class="register-box-right col-12 col-md-5 py-5 px-6"
  >
    <validation-observer ref="obsRegister">
      <p class="register-box-title size-22 mb-2">ĐĂNG KÝ NHẬN TRẢI NGHIỆM NGAY</p>
      <p class="register-box-subtitle text-center" v-if="showSubtitle">
        Demo giải pháp hợp đồng điện tử MDO
      </p>
      ...
      <v-btn
        ...
        dark
        rounded
        @click="onRegister('/thankyou')"
        id="btn-register-landing"
        >Đăng ký
