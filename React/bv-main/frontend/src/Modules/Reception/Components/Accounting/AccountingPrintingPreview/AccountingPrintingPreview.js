...
const AccountingPrintingPreview = (props) => {
  ...
  useEffect(() => {
    if(items.filter(el => el.quantity > 0).length>18){
      ...
      setHeightPaperA5('heightPaperA5')
      ...
      setHeightPaperA5('heightPaperAbsolute')
  ...
  return (
    <Fragment>
      <div className="d-flex justify-content-center font-print mt-3">
        <div
          className="border border-secondary AccountingPrintingPreview"
          style={{ display: "none" }}
        >
          <div className="p-2 position-relative" id="transactionPrint">
            <div className={`${heightPaperA5} receiptFromPrint`}>
              ...
              <div className="text-center">Liên 1 : Lưu tại quầy</div>
              <div className="text-center">
                <i>
                  {current.getHours()} giờ {current.getMinutes()} phút,Ngày{" "}
                  {current.getDate()} Tháng {current.getMonth() + 1} Năm{" "}
                  {current.getFullYear()}
                </i>
              </div>
              <div className="d-block">
                ...
                <span className="ml-10 ">
                  NS: {convertToStrDate(customerBirthday.value)}{" "}
                  {`(${getAge(convertToStrDate(customerBirthday.value))})`}
                </span>
                <span className="ml-10 ">
                  GT: {customerGender.value === "male" ? " Nam" : " Nữ"}{" "}
                </span>
                ...
                <div style={{ width: "100%" }}>
                    ...
                    {items
                      ...
                      .map((el) => (
                        <div style={{ display: "flex", position: "relative" }}>
                          <p style={{ marginBottom: "0", width: "60%" }}>
                            {el.ref_value.name}
                          </p>
                          <p
                            style={{
                  ...
                  <b>
                    <span className="font-weight-bold">
                      {new Intl.NumberFormat("de-DE").format(origin_total)} VNĐ
                    </span>
                  </b>
                  <br></br>
                  <span className="font-weight-bold mr-10">
                    {" "}
                    Tổng tiền khuyến mãi:{" "}
                    <b>
                      {new Intl.NumberFormat("de-DE").format(discount_price)}{" "}
                      VNĐ
                    </b>{" "}
                  </span>
                  <span className="font-weight-bold">
                    ...
                    <b>
                      {new Intl.NumberFormat("de-DE").format(totalPrice.value)}{" "}
                      VNĐ
                    </b>{" "}
                  </span>
                  <br></br>
                  Viết bằng chữ:{" "}
                  <span className="font-weight-bold">
                    <b>{moneyToWord(totalPrice.value || 0)}</b>
                  </span>{" "}
                  <br></br>
                  <span>
                    Ngày trả kết quả :..giờ...phút, ngày...tháng...năm 2022{" "}
                    <br></br>
                    (Lưu ý mang theo biên lai khi đi nhận kết quả)
                  </span>
                </div>
              </div>
              <br></br>
              <div className="d-flex justify-content-between px-1 ">
                ...
                <div className={`text-center mr-5 tt ${receptionAcc}`}>
                  ...
                  <br></br>
                  <i className="mb-2">(ký, ghi rõ họ tên)</i> <br></br>
                  <br></br>
                  <br></br>
            ...
            <div className={`${heightPaperA5} receiptFromPrint`}>
              ...
              <div className="text-center">Liên 2 : Giao cho bệnh nhân</div>
              <div className="text-center">
                <i>
                  {current.getHours()} giờ {current.getMinutes()} phút,Ngày{" "}
                  {current.getDate()} Tháng {current.getMonth() + 1} Năm{" "}
