            ...
            <div className="d-flex justify-content-center mt-3">
                <div className="p-2 border border-secondary examReceiptContainer">
                    <div className="position-relative" id="receiptPrint">
                        <div className="receiptFromPrint" style={{marginBottom:'500px'}}>
                            ...
                            <div>
                                ...
                                <Col>
                                    <span >Ngày sinh: {convertToStrDate(customer.birthday)} ({age})</span>
                            ...
                            <div className="d-flex" >
                                ...
                                <Col sm={5} className='personPay1' >
                                    <b>Người nộp tiền</b><br></br>
                                    <i>(ký, họ tên)</i>
                                </Col>
                                <Col sm={1} >
                                </Col>
                                <Col sm={5} className='reception1'    >
                        ...
                        <div className="receiptFromPrint" style={{marginBottom:'500px'}}>
                            ...
                            <div className="d-flex ">
                                ...
                                <Col sm={5} className="personPay2">
                                    <b>Người nộp tiền</b><br></br>
                                    <i>(ký, họ tên)</i>
                                </Col>
                                <Col sm={1} >
                                </Col>
                                <Col sm={5} className="reception2"    >
                                    <strong>Người thu tiền</strong><br></br>
                                    <i className="mb-2">(ký, ghi rõ họ tên)</i> <br></br><br></br><br></br>
                                    <b className="mt-5">{doctorInfo.full_name}</b>
                                </Col>
