    ...
    <v-container style="margin-bottom: 15px">
      <v-toolbar
        ...
        <div
          ...
          <v-toolbar-title style="padding-bottom: 4px" class="d-flex justify-lg-end pa-16 ml-16">
            <a href="/" class="app-logo d-flex align-center"
            ><img class="img-logo" src="~assets/images/logo-mdo.svg" alt="Logo MDO 1"/>
              <span class="primary--text">mdo.com.vn</span></a
            ></v-toolbar-title
          >
          <v-spacer></v-spacer>
          <v-toolbar-items
              style="padding-right: 230px;padding-bottom: 4px"
...
import DialogRegister from '../components/DialogRegisterLanding.vue';
